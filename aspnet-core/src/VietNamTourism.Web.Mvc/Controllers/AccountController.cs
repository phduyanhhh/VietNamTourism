...
using VietNamTourism.Web.Models.Account;
using VietNamTourism.Web.Views.Shared.Components.TenantChange;
...
public class AccountController : VietNamTourismControllerBase
{
	...
	{
		return RedirectToAction("Index", "Dashboard", new { area = "Tms" });
	}

	public string GetAppHomeUrl()
	{
		return Url.Action("Index", "Dashboard", new { area = "Tms" });
	}
