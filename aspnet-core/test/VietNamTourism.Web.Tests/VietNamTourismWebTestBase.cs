...
public abstract class VietNamTourismWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static VietNamTourismWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(VietNamTourismWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<VietNamTourismDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<VietNamTourismDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<VietNamTourismDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<VietNamTourismDbContext, Task<T>> func)
    {
        T result;
